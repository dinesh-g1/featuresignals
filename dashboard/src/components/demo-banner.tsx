      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/80 backdrop-blur-sm">
        <div className="mx-4 max-w-md rounded-2xl bg-white p-8 shadow-2xl">
          ...
          <p className="mt-2 text-center text-sm text-slate-500">
            Choose a plan to continue using FeatureSignals with all your data.
          </p>
    ...
    return (
      <div className="flex items-center justify-between bg-amber-500 px-4 py-2.5 text-sm text-white">
        <div className="flex items-center gap-2">
          ...
          <span className="hidden sm:inline">Choose a plan to keep your data and continue.</span>
        </div>
        <Link
          href="/register?source=demo"
  ...
  return (
    <div className="flex items-center justify-between bg-indigo-600 px-4 py-2 text-sm text-white">
      <div className="flex items-center gap-2">
        ...
        <span>
          Free trial &mdash; {daysRemaining} day{daysRemaining !== 1 ? "s" : ""} remaining.
        </span>
      </div>
      <Link
        href="/register?source=demo"
