...
export default function AppError({
  ...
  return (
    <div
      className="flex flex-col items-center justify-center px-4 py-20 text-center animate-fade-in sm:py-28"
      role="alert"
    >
      {/* Icon */}
      ...
      {/* Subtle error reference for support (only digest, not the full error) */}
      {error.digest && (
...
function getFriendlyMessage(error: Error): {
  ...
  return {
    title: "Something Went Wrong",
    description:
      "An unexpected error occurred while loading this page. Don't worry — your data is safe. You can try again or return to the dashboard.",
  };
}
