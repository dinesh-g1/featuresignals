...
export default function ProjectsEnvironmentsPage() {
  return (
    <div>
      ...
      <p className="text-[var(--fgColor-default)] mb-4">A project represents a single application or service. Each project has its own set of flags, environments, and segments.</p>
      <CodeBlock
        language="bash"
  ...
  -d '{"name": "Mobile App", "slug": "mobile-app"}'`}
      ...
      <p className="text-[var(--fgColor-default)] mb-4">Environments represent deployment stages. Default environments created on registration:</p>
      <SimpleTable>
        <thead>
      ...
      <p className="text-[var(--fgColor-default)] mb-4">The same flag can be:</p>
      ...
      <p className="text-[var(--fgColor-default)] mb-4">Each environment has its own API keys. There are two types:</p>
      <SimpleTable>
        <thead>
      ...
      <div className="p-4 mb-6 rounded-lg border border-[var(--borderColor-attention-muted)] bg-[var(--bgColor-attention-muted)]">
        <p className="text-sm text-[var(--fgColor-default)]"><strong>Caution:</strong> The full API key is shown <strong>only once</strong> in the response. Store it securely.</p>
      </div>

      <SectionHeading>Flag Promotion</SectionHeading>
      <p className="text-[var(--fgColor-default)] mb-4">Promote flag configurations from one environment to another:</p>
      <CodeBlock
        language="bash"
  ...
  -d '{"source_env_id": "dev-env-id", "target_env_id": "staging-env-id"}'`}
      />
      <p className="text-sm text-[var(--fgColor-muted)] mb-6">Promotion copies the enabled state, default value, targeting rules, and percentage rollout from the source to the target environment.</p>
