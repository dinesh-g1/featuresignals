  ...
  return (
    <div>
      ...
      <p className="text-lg text-[var(--fgColor-muted)] mb-8 leading-relaxed">
        ...
        <a href="https://martinfowler.com/articles/feature-toggles.html" className="text-[var(--fgColor-accent)] hover:underline">Feature Toggles</a> taxonomy.
      </p>
      ...
      <p className="text-[var(--fgColor-default)] mb-4">Ops toggles control operational aspects of system behavior — circuit breakers, degradation switches, maintenance modes.</p>
      <ul className="list-disc pl-6 space-y-1 text-[var(--fgColor-default)] mb-4">
      ...
      <p className="text-[var(--fgColor-default)] mb-4">Permission toggles gate access to features for specific user segments, tenants, or pricing tiers.</p>
      <ul className="list-disc pl-6 space-y-1 text-[var(--fgColor-default)] mb-4">
        <li>Default staleness threshold: <strong>90 days</strong></li>
...
function Td({ children, className }: { children: React.ReactNode; className?: string }) {
  return <td className={`px-4 py-2.5 text-[var(--fgColor-default)] ${className || ""}`}>{children}</td>;
}
