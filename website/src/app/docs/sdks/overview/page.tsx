  ...
  return (
    <div>
      ...
      <SimpleTable>
        ...
        <tbody>
          <Tr>
            <Td><Link href="/docs/sdks/go" className="text-[var(--signal-fg-accent)] hover:underline font-medium">Go</Link></Td>
            <Td>Go 1.22+</Td>
            <Td>Server</Td>
            <Td><InlineCode>github.com/featuresignals/sdk-go</InlineCode></Td>
          </Tr>
          <Tr>
            <Td><Link href="/docs/sdks/nodejs" className="text-[var(--signal-fg-accent)] hover:underline font-medium">Node.js</Link></Td>
            <Td>TypeScript/Node 22+</Td>
            <Td>Server</Td>
            <Td><InlineCode>@featuresignals/node</InlineCode></Td>
          </Tr>
          <Tr>
            <Td><Link href="/docs/sdks/python" className="text-[var(--signal-fg-accent)] hover:underline font-medium">Python</Link></Td>
            <Td>Python 3.9+</Td>
            <Td>Server</Td>
            <Td><InlineCode>featuresignals</InlineCode></Td>
          </Tr>
          <Tr>
            <Td><Link href="/docs/sdks/java" className="text-[var(--signal-fg-accent)] hover:underline font-medium">Java</Link></Td>
            <Td>Java 17+</Td>
            <Td>Server</Td>
            <Td><InlineCode>com.featuresignals:sdk-java</InlineCode></Td>
          </Tr>
          <Tr>
            <Td><Link href="/docs/sdks/dotnet" className="text-[var(--signal-fg-accent)] hover:underline font-medium">.NET</Link></Td>
            <Td>.NET 8.0+ / C#</Td>
            <Td>Server</Td>
            <Td><InlineCode>FeatureSignals</InlineCode></Td>
          </Tr>
          <Tr>
            <Td><Link href="/docs/sdks/ruby" className="text-[var(--signal-fg-accent)] hover:underline font-medium">Ruby</Link></Td>
            <Td>Ruby 3.1+</Td>
            <Td>Server</Td>
            <Td><InlineCode>featuresignals</InlineCode></Td>
          </Tr>
          <Tr>
            <Td><Link href="/docs/sdks/react" className="text-[var(--signal-fg-accent)] hover:underline font-medium">React</Link></Td>
            <Td>React 18+</Td>
            <Td>Client</Td>
            <Td><InlineCode>@featuresignals/react</InlineCode></Td>
          </Tr>
          <Tr>
            <Td><Link href="/docs/sdks/vue" className="text-[var(--signal-fg-accent)] hover:underline font-medium">Vue</Link></Td>
            <Td>Vue 3.3+</Td>
            <Td>Client</Td>
      ...
      <p className="text-[var(--signal-fg-primary)] mb-4">All SDKs follow the same core design:</p>
      <CodeBlock
        language="text"
        code={`┌──────────┐    HTTP/SSE     ┌──────────────┐
│   SDK     │ ──────────────▶│  API Server   │
...
└──────────┘`}
      />
      <ol className="list-decimal pl-6 space-y-1 text-[var(--signal-fg-primary)] mt-4 mb-6">
        <li>
      ...
      <p className="text-[var(--signal-fg-primary)] mb-3">All SDKs accept:</p>
      <SimpleTable>
        <thead>
          <tr>
            <Th>Option</Th>
...
client.Dispose(); // C#`}
      ...
      <p className="text-[var(--signal-fg-primary)] mb-6">
        ...
        <Link href="/docs/sdks/openfeature" className="text-[var(--signal-fg-accent)] hover:underline">
          OpenFeature guide
        </Link>{" "}
        for details.
      </p>
