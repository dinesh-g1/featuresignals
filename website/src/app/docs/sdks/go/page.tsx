...
export default function GoSdkPage() {
  return (
    <div>
      <h1 id="docs-main-heading" className="text-3xl sm:text-4xl font-bold tracking-tight text-[var(--fgColor-default)] mb-3">Go SDK</h1>
      <p className="text-lg text-[var(--fgColor-muted)] mb-8 leading-relaxed">Thread-safe client for evaluating feature flags in Go applications.</p>

      <SectionHeading>Installation</SectionHeading>
      <CodeBlock language="bash" code="go get github.com/featuresignals/sdk-go" />
      <p className="text-sm text-[var(--fgColor-muted)] mb-6"><strong>Requirements:</strong> Go 1.22+</p>
