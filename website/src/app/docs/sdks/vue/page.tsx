...
export default function VueSdkPage() {
  return (
    <div>
      <h1 id="docs-main-heading" className="text-3xl sm:text-4xl font-bold tracking-tight text-[var(--fgColor-default)] mb-3">Vue SDK</h1>
      <p className="text-lg text-[var(--fgColor-muted)] mb-8 leading-relaxed">Composables for evaluating feature flags in Vue 3 applications using the Composition API.</p>

      <SectionHeading>Installation</SectionHeading>
      <CodeBlock language="bash" code="npm install @featuresignals/vue" />
      <p className="text-sm text-[var(--fgColor-muted)] mb-6"><strong>Requirements:</strong> Vue 3.3+</p>
