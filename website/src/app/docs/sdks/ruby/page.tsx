...
export default function RubySdkPage() {
  return (
    <div>
      <h1 id="docs-main-heading" className="text-3xl sm:text-4xl font-bold tracking-tight text-[var(--fgColor-default)] mb-3">Ruby SDK</h1>
      <p className="text-lg text-[var(--fgColor-muted)] mb-8 leading-relaxed">Thread-safe client for evaluating feature flags in Ruby applications.</p>

      <SectionHeading>Installation</SectionHeading>
      <CodeBlock language="ruby" code={`# Gemfile
gem "featuresignals"`} />
      <p className="text-sm text-[var(--fgColor-muted)] mb-6"><strong>Requirements:</strong> Ruby 3.1+</p>
