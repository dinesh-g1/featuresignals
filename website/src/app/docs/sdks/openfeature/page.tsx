...
export default function OpenFeaturePage() {
  return (
    <div>
      <h1 id="docs-main-heading" className="text-3xl sm:text-4xl font-bold tracking-tight text-[var(--signal-fg-primary)] mb-3">OpenFeature Integration</h1>
      <p className="text-lg text-[var(--signal-fg-secondary)] mb-8 leading-relaxed">
        All FeatureSignals SDKs ship with an{" "}
        <a href="https://openfeature.dev/" className="text-[var(--signal-fg-accent)] hover:underline">OpenFeature</a> provider,
        giving you a vendor-neutral API for feature flag evaluation.
      </p>

      <SectionHeading>How It Works</SectionHeading>
      <p className="text-[var(--signal-fg-primary)] mb-4">Each SDK includes a <strong>local provider</strong> that bridges the FeatureSignals client to the OpenFeature API:</p>
