...
export default function Soc2Page() {
  return (
    <div>
      <h1 id="docs-main-heading" className="text-3xl sm:text-4xl font-bold tracking-tight text-[var(--fgColor-default)] mb-3">SOC 2 Controls Matrix</h1>
      <p className="text-sm text-[var(--fgColor-muted)] mb-4">Last updated: April 2026</p>
      <div className="p-4 mb-8 rounded-lg border border-[var(--borderColor-accent-muted)] bg-[var(--bgColor-accent-muted)]">
        <p className="text-sm text-[var(--fgColor-muted)]">This document maps SOC 2 Trust Service Criteria to technical controls. A formal SOC 2 Type II audit is on our roadmap.</p>
      </div>
