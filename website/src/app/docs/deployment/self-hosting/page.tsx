...
export default function SelfHostingPage() {
  return (
    <div>
      <h1 id="docs-main-heading" className="text-3xl sm:text-4xl font-bold tracking-tight text-[var(--signal-fg-primary)] mb-3">Self-Hosting Guide</h1>
      <p className="text-lg text-[var(--signal-fg-secondary)] mb-8 leading-relaxed">Run FeatureSignals on your own infrastructure for full control over your data and deployment.</p>

      <SectionHeading>Infrastructure Requirements</SectionHeading>
      <h3 className="text-base font-semibold text-[var(--signal-fg-primary)] mt-6 mb-2">Minimum (Development/Small Teams)</h3>
      ...
      <h3 className="text-base font-semibold text-[var(--signal-fg-primary)] mt-6 mb-2">Recommended (Production)</h3>
