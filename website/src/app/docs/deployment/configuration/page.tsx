...
export default function ConfigurationPage() {
  return (
    <div>
      <h1 id="docs-main-heading" className="text-3xl sm:text-4xl font-bold tracking-tight text-[var(--fgColor-default)] mb-3">Configuration Reference</h1>
      <p className="text-lg text-[var(--fgColor-muted)] mb-8 leading-relaxed">All configuration is done via environment variables.</p>
      ...
      <div className="p-4 mb-6 rounded-lg border border-[var(--borderColor-attention-muted)] bg-[var(--bgColor-attention-muted)]">
        <p className="text-sm text-[var(--fgColor-default)]"><strong>Caution:</strong> <InlineCode>NEXT_PUBLIC_API_URL</InlineCode> must be accessible from the user&apos;s browser. In production, use the public API URL.</p>
      </div>
