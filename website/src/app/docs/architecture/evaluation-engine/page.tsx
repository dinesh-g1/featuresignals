...
export default function EvaluationEnginePage() {
  return (
    <div>
      <h1 id="docs-main-heading" className="text-3xl sm:text-4xl font-bold tracking-tight text-[var(--fgColor-default)] mb-3">Evaluation Engine</h1>
      <p className="text-lg text-[var(--fgColor-muted)] mb-8 leading-relaxed">The evaluation engine is the core of FeatureSignals. It determines what value a feature flag returns for a given evaluation context.</p>
...
9. Fallthrough           → default value`} />
      <p className="text-[var(--fgColor-default)] mb-6">Each step short-circuits — the first matching condition determines the result.</p>

      <SectionHeading>Consistent Hashing</SectionHeading>
      <p className="text-[var(--fgColor-default)] mb-4">FeatureSignals uses <strong>MurmurHash3 (x86, 32-bit)</strong> for all bucket assignments:</p>
