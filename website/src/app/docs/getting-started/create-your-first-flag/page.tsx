  ...
  return (
    <div>
      ...
      <p className="text-[var(--fgColor-default)] mb-4">
        ...
        <a href="https://app.featuresignals.com" className="text-[var(--fgColor-accent)] hover:underline">https://app.featuresignals.com</a>.
      ...
      <p className="text-[var(--fgColor-default)] mb-4">Navigate to <strong>Flags</strong> and click <strong>Create Flag</strong>.</p>
      <SimpleTable>
        <thead>
          <tr>
            <Th>Field</Th>
      ...
      <p className="text-[var(--fgColor-muted)] text-sm mb-6">
      ...
      <p className="text-[var(--fgColor-default)] mb-4">Flags are <strong>disabled by default</strong> in all environments. To enable:</p>
      ...
      <p className="text-[var(--fgColor-default)] mb-4">Targeting rules let you return specific values based on user attributes:</p>
      ...
      <p className="text-[var(--fgColor-default)] mb-6">Now only users with <InlineCode>country: &quot;US&quot;</InlineCode> in their evaluation context get <InlineCode>true</InlineCode>.</p>
...
// → false`}
      ...
      <p className="text-[var(--fgColor-default)] mb-4">Instead of enabling for all users, do a percentage rollout:</p>
      <ol className="list-decimal pl-6 space-y-1 text-[var(--fgColor-default)] mb-6">
        <li>Set <strong>Percentage Rollout</strong> to <InlineCode>2500</InlineCode> (25%)</li>
        <li>Save</li>
      </ol>
      <p className="text-[var(--fgColor-default)] mb-6">Now 25% of users (deterministically based on their key) see <InlineCode>true</InlineCode>.</p>
