...
export default function AuditLoggingPage() {
  return (
    <div>
      <h1 id="docs-main-heading" className="text-3xl sm:text-4xl font-bold tracking-tight text-[var(--fgColor-default)] mb-3">Audit Logging</h1>
      <p className="text-lg text-[var(--fgColor-muted)] mb-8 leading-relaxed">FeatureSignals maintains a comprehensive audit log that records all changes to flags, environments, and team configuration. The log is tamper-evident and includes before/after state diffs.</p>
