...
export default function RelayProxyPage() {
  return (
    <div>
      <h1 id="docs-main-heading" className="text-3xl sm:text-4xl font-bold tracking-tight text-[var(--fgColor-default)] mb-3">Relay Proxy</h1>
      <p className="text-lg text-[var(--fgColor-muted)] mb-8 leading-relaxed">The relay proxy is a lightweight Go binary that caches flag values from the central FeatureSignals API and serves them locally.</p>
