...
export default function MigrationPage() {
  return (
    <div>
      <h1 id="docs-main-heading" className="text-3xl sm:text-4xl font-bold tracking-tight text-[var(--fgColor-default)] mb-3">Migration Overview</h1>
      <p className="text-lg text-[var(--fgColor-muted)] mb-8 leading-relaxed">FeatureSignals provides a built-in migration system that lets you import feature flags, environments, segments, and targeting rules from other feature flag platforms.</p>
