...
export default function SchedulingPage() {
  return (
    <div>
      <h1 id="docs-main-heading" className="text-3xl sm:text-4xl font-bold tracking-tight text-[var(--signal-fg-primary)] mb-3">Flag Scheduling</h1>
      <p className="text-lg text-[var(--signal-fg-secondary)] mb-8 leading-relaxed">Schedule flags to automatically enable or disable at specific times. Useful for timed releases, promotions, or time-limited features.</p>

      <SectionHeading>How It Works</SectionHeading>
      <p className="text-[var(--signal-fg-primary)] mb-4">The server runs a background scheduler that checks every <strong>30 seconds</strong> for pending schedules. When a schedule triggers, the flag state is updated, an audit entry is created, and SSE notifications are broadcast.</p>
