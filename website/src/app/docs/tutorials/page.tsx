...
export default function FeatureFlagCheckoutPage() {
  return (
    <div>
      <h1 id="docs-main-heading" className="text-3xl sm:text-4xl font-bold tracking-tight text-[var(--signal-fg-primary)] mb-3">Feature Flag a Checkout Flow</h1>
      <p className="text-lg text-[var(--signal-fg-secondary)] mb-8 leading-relaxed">Learn how to wrap a new checkout experience behind a feature flag and roll it out safely.</p>
