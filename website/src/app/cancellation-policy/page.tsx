  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12 sm:py-16">
      ...
      <div className="prose prose-stone max-w-none space-y-6 text-sm text-stone-600 leading-relaxed">
        ...
        <p>
          You may cancel your FeatureSignals subscription at any time. No
          long-term contracts are required for monthly or annual plans.
          Enterprise plans are subject to the terms of your Enterprise
          Agreement.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li>
            <strong>Self-Service (Pro):</strong> Go to Settings → Billing →
            Cancel Subscription in the dashboard. Cancellation takes effect
            immediately.
          </li>
          <li>
            <strong>Enterprise:</strong> Contact your account manager or email
            us at{" "}
            <a
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>
            You will be downgraded to the Free tier at the end of the billing
            period
          </li>
          <li>
            Flags that exceed Free tier limits will be disabled but not deleted
          </li>
          <li>
            You retain read-only access to your data for 30 days after the
            billing period ends
          </li>
        </ul>
        ...
        <p>
          We strongly recommend exporting your data before cancellation. You can
          export:
        </p>
        <ul className="list-disc pl-6 space-y-1">
        ...
        <p>
          After 30 days following the end of your billing period, your data may
          be permanently deleted. We provide a grace period for data recovery —
        ...
        <p>
          You can reactivate your subscription at any time within 90 days of
          cancellation. Your flags, segments, and configurations will be
          restored to their pre-cancellation state. After 90 days, data may no
          longer be available for recovery.
        </p>
        ...
        <p>
          If you cancel a paid plan, your account automatically downgrades to
          the Free tier. The following limits apply:
        </p>
        <ul className="list-disc pl-6 space-y-1">
        ...
        <p>
          In such cases, we will provide notice where possible and a 14-day
          window to appeal or export data before permanent deletion.
        </p>
