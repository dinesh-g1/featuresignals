      ...
      <section className="mx-auto max-w-lg px-6 py-20 text-center">
        <SectionReveal>
          ...
          <p className="mt-3 text-slate-600">
            Thank you for your interest. Our team will get back to you within one business day.
          </p>
          <Link
            href="/"
      ...
      <SectionReveal>
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-base text-slate-500">
            Get a personalized demo, discuss enterprise requirements, or start a proof-of-concept.
          </p>
        </div>
      </SectionReveal>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6">
              ...
              <p className="mt-1 text-sm text-slate-500">
                ...
                <a href="mailto:enterprise@featuresignals.com" className="font-medium text-indigo-600 hover:text-indigo-700">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                >
                  ...
                  {TEAM_SIZES.map((size) => (
                    <option key={size} value={size}>{size} developers</option>
                  ))}
                </select>
              </div>
            </div>
