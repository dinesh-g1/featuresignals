...
function accentColors(accent: Accent) {
  switch (accent) {
    case "accent":
      return {
        iconBg: "bg-[var(--bgColor-accent-muted)]",
        iconFg: "text-[var(--fgColor-accent)]",
        border: "border-[var(--fgColor-accent)]",
        ring: "ring-[var(--fgColor-accent)]",
        dot: "bg-[var(--fgColor-accent)]",
      };
    case "success":
      return {
        iconBg: "bg-[var(--bgColor-success-muted)]",
        iconFg: "text-[var(--fgColor-success)]",
        border: "border-[var(--fgColor-success)]",
        ring: "ring-[var(--fgColor-success)]",
        dot: "bg-[var(--fgColor-success)]",
      };
    case "done":
      return {
        iconBg: "bg-[var(--bgColor-done-muted)]",
        iconFg: "text-[var(--fgColor-done)]",
        border: "border-[var(--fgColor-done)]",
        ring: "ring-[var(--fgColor-done)]",
        dot: "bg-[var(--fgColor-done)]",
      };
    case "attention":
      return {
        iconBg: "bg-[var(--bgColor-attention-muted)]",
        iconFg: "text-[var(--fgColor-attention)]",
        border: "border-[var(--fgColor-attention)]",
        ring: "ring-[var(--fgColor-attention)]",
        dot: "bg-[var(--fgColor-attention)]",
      };
  }
}
...
function ContactFormSection() {
  return (
    <section
      id="contact-form"
      className="py-16 sm:py-24 bg-[var(--bgColor-inset)]"
    ...
    >
      <div className="mx-auto max-w-6xl px-6">
        <motion.div className="text-center max-w-2xl mx-auto mb-14" {...fadeUp}>
          ...
          <p className="text-base text-[var(--fgColor-muted)]">
        ...
        <div className="grid lg:grid-cols-5 gap-10 lg:gap-14">
          ...
          <aside className="lg:col-span-2 space-y-5">
            ...
            {/* Office Address */}
            <motion.div
              className="rounded-xl border border-[var(--borderColor-default)] bg-[var(--bgColor-default)] p-5"
              initial={{ opacity: 0, x: -20 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true, margin: "-40px" }}
              transition={{
            ...
            >
              <div className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-lg bg-[var(--bgColor-accent-muted)] flex items-center justify-center shrink-0">
                  <LocationIcon
                    size={18}
                ...
                <div className="min-w-0">
                  ...
                  <address className="not-italic text-xs text-[var(--fgColor-muted)] leading-relaxed">
            ...
            >
              <div className="w-2 h-2 rounded-full bg-[var(--fgColor-success)]" />
          ...
          <div className="lg:col-span-3">
            <Suspense
              fallback={
                <div className="rounded-2xl border border-[var(--borderColor-default)] bg-[var(--bgColor-default)] p-8 animate-pulse">
                  <div className="space-y-5">
                    <div className="h-12 bg-[var(--bgColor-muted)] rounded-lg" />
                    <div className="h-12 bg-[var(--bgColor-muted)] rounded-lg" />
                    <div className="h-12 bg-[var(--bgColor-muted)] rounded-lg" />
                    <div className="h-12 bg-[var(--bgColor-muted)] rounded-lg" />
                    <div className="h-32 bg-[var(--bgColor-muted)] rounded-lg" />
                    <div className="h-11 bg-[var(--bgColor-muted)] rounded-lg" />
                  </div>
                </div>
              }
            >
...
function ContactForm() {
  ...
  const inputClassName = (field: keyof FormErrors) =>
    cn(
      "block w-full rounded-lg border bg-[var(--bgColor-default)] px-4 py-3 text-sm text-[var(--fgColor-default)] placeholder:text-[var(--fgColor-muted)] transition-all duration-200 outline-none",
      "focus:border-[var(--fgColor-accent)] focus:ring-2 focus:ring-[var(--fgColor-accent)]/20",
      touched[field] && errors[field]
        ? "border-[var(--fgColor-danger)] ring-2 ring-[var(--fgColor-danger)]/20"
        : "border-[var(--borderColor-default)]",
    );

  const labelClassName =
    "block text-xs font-semibold text-[var(--fgColor-default)] mb-1.5";

  const errorClassName = "text-xs text-[var(--fgColor-danger)] mt-1.5";
  ...
  if (status === "success") {
    return (
      <motion.div
        className="rounded-2xl border border-[var(--borderColor-default)] bg-[var(--bgColor-default)] p-10 text-center"
        initial={{ opacity: 0, scale: 0.96 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.4, ease: [0.16, 1, 0.3, 1] }}
      >
        <motion.div
          className="w-16 h-16 rounded-full bg-[var(--bgColor-success-muted)] flex items-center justify-center mx-auto mb-6"
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          transition={{
            type: "spring",
        ...
        >
          ...
          >
            <CheckIcon size={32} className="text-[var(--fgColor-success)]" />
          </motion.div>
        </motion.div>
        <h3 className="text-xl font-bold text-[var(--fgColor-default)] mb-2">
          Thank you!
        </h3>
  ...
  return (
    <motion.form
      ...
      noValidate
      className="rounded-2xl border border-[var(--borderColor-default)] bg-[var(--bgColor-default)] p-8 shadow-[var(--shadow-resting-small)]"
      initial={{ opacity: 0, y: 16 }}
      ...
      <div className="space-y-5">
        ...
        <div>
          <label htmlFor="contact-name" className={labelClassName}>
            Name <span className="text-[var(--fgColor-danger)]">*</span>
          </label>
          <input
            id="contact-name"
            type="text"
        ...
        <div>
          <label htmlFor="contact-email" className={labelClassName}>
            Email <span className="text-[var(--fgColor-danger)]">*</span>
          </label>
          <input
            id="contact-email"
            type="email"
        ...
        <div>
          <label htmlFor="contact-message" className={labelClassName}>
            Message <span className="text-[var(--fgColor-danger)]">*</span>
          </label>
          <textarea
            id="contact-message"
            name="message"
        ...
        {status === "error" && (
          <motion.div
            className="flex items-center gap-2 rounded-lg border border-[var(--fgColor-danger)]/30 bg-[var(--bgColor-danger-muted)] px-4 py-3"
        ...
        <button
          ...
          className={cn(
            ...
            "bg-[var(--bgColor-accent-emphasis)] hover:bg-[#0757ba]",
        ...
        <p className="text-xs text-[var(--fgColor-muted)] text-center">
