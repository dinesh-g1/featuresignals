    ...
    <div className="min-h-screen pt-16 flex items-center justify-center bg-[var(--bgColor-default)]">
      <div className="max-w-lg mx-auto px-6 py-20 text-center">
        ...
        <div className="-mt-12 mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-[var(--fgColor-default)] mb-3">
            This page doesn&apos;t exist.
          </h1>
          <p className="text-[var(--fgColor-muted)] leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold text-white bg-[var(--bgColor-accent-emphasis)] hover:bg-[#0757ba] transition-colors duration-150"
          >
            <HomeIcon size={16} />
            Go Home
          </Link>
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold text-[var(--fgColor-default)] bg-[var(--bgColor-muted)] hover:bg-[#eff2f5] border border-[var(--borderColor-default)] transition-colors duration-150"
          >
            <SearchIcon size={16} />
            Search Docs
          </a>
