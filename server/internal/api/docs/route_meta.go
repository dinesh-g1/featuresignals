...
var AllRouteMeta = []RouteMeta{
	...
	{Method: "GET", Path: "/v1/billing/credits", Tag: "Billing", Summary: "List credit balances", Description: "Returns all cost bearers with current credit balance, included monthly units, and available credit packs.", Security: []string{"bearer"}, Status: 200},
	{Method: "GET", Path: "/v1/billing/credits/balance", Tag: "Billing", Summary: "Get credit balance", Description: "Returns lightweight credit balance summary for the org.", Security: []string{"bearer"}, Status: 200},
	{Method: "GET", Path: "/v1/billing/credits/history", Tag: "Billing", Summary: "Get credit history", Description: "Returns credit purchase and consumption history with pagination.", Security: []string{"bearer"}, Status: 200},
	{Method: "POST", Path: "/v1/billing/credits/purchase", Tag: "Billing", Summary: "Purchase credits", Description: "Purchases a credit pack for the org. Adds credits to balance.", Security: []string{"bearer"}, ReqType: "PurchaseCreditsRequest", Status: 200},
	...
	{Method: "DELETE", Path: "/v1/projects/{projectID}/flags/{flagKey}", Tag: "Flags", Summary: "Retire feature", Description: "Retires a feature flag and all associated state.", Security: []string{"bearer"}, Status: 204},
